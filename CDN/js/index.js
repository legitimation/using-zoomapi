...
function websdkready() {
  ...
  var API_KEY = "fRzdph8YQ72AytEUHzOLUw";
   ...
   */
  var API_SECRET = "kM3rx7y4kGoTW113lUdssGjhTZdFpdML99Gk";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "C:/Users/user/madcamp-w3/sample-app-web-master/using-zoomapi/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
