...
const API_KEY = "fRzdph8YQ72AytEUHzOLUw";
/**
 ...
 */
const API_SECRET = "kM3rx7y4kGoTW113lUdssGjhTZdFpdML99Gk";
...
document.getElementById("join_meeting").addEventListener("click", (e) => {
  ...
  const signature = ZoomMtg.generateSignature({
    ...
    success: function (res) {
      ...
      const joinUrl = "C:/Users/user/madcamp-w3/sample-app-web-master/using-zoomapi/CDN/meeting.html?" + testTool.serialize(meetingConfig);
      console.log(joinUrl);
  ...
  const signature = ZoomMtg.generateSignature({
    ...
    success: function (res) {
      ...
      const joinUrl =
        ...
        "C:/Users/user/madcamp-w3/sample-app-web-master/using-zoomapi/CDN/meeting.html?" +
